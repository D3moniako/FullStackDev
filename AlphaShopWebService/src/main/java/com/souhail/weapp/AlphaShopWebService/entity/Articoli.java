...
//    @NotNull(message="{NotNull.Articoli.codArt.Validation}")
    ...
    @JsonManagedReference // quando leggo i dati da db vengono convertiti in formato json, questa annotation serve per cio
    private Set<Barcode> barcode =new HashSet<>();

    @OneToOne(cascade= CascadeType.ALL, mappedBy = "articolo",orphanRemoval = true) // il mappedby fa riferimento al nome della variabile associata all'altra parte
