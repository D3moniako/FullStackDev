...
private final String JsonData =
	...
	{ // errore che parte nel caso si inserisca lo stesso articolo
		mockMvc.perform(MockMvcRequestBuilders.post("/api/articoli/inserisci")
				.contentType(MediaType.APPLICATION_JSON)
				.content(JsonData)
				.accept(MediaType.APPLICATION_JSON))
	...
	{ // controlla errore nel caso un campo non sia riempito in questo caso specifico la descrizione, dovrei verificare tutto
		mockMvc.perform(MockMvcRequestBuilders.post("/api/articoli/inserisci")
				.contentType(MediaType.APPLICATION_JSON)
				.content(ErrJsonData)
				.accept(MediaType.APPLICATION_JSON))
