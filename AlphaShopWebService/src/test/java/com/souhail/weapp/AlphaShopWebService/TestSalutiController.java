...
// inserisco la classe dell'entry point dell'app, cioè dove sta il main
public class TestSalutiController {
    ...
    @BeforeEach
    // prima di ciascun junit test verrà eseguito questo metodo setup che mi crea l'ambiente per avviare il test
    public void setup() {
